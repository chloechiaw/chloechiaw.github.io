...
I am still learning, so this is a novice worklog describing all the things tried! This post is inspired by this wonderful [worklog](https://maharshi.bearblog.dev/optimizing-softmax-cuda/) 
